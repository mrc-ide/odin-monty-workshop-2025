...
* Monday: [writing odin code](slides/odin.html)
* Tuesday: [fitting odin models to data](slides/fitting.html)
...
* Windows: Install "RTools", for 4.4.x of R see [these instructopns](https://cran.r-project.org/bin/windows/Rtools/rtools44/rtools.html)
