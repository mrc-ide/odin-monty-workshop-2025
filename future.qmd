...
## Random Walk vs Gradient-Based Inference
...
- Random-walk MCMC becomes inefficient when
  - Dimensionality is high
  - Non-linear correlation structure
- Gradient gives the local direction at a point

## Backward automatic differentiation {.smaller}

![](images/SSM_autodiff.png)

- Algorithm developed for `odin` models, but not fully implemented
- Does not scale with number of parameters!
- Pilot test: for 2.5 times the likelihood time, we get likelihood + "exact" gradient
